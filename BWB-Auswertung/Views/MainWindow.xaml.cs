...
namespace LagerInsights
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        public async Task<bool> CheckForUpdate()
        {
            try
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    HttpResponseMessage response = await client.GetAsync(LagerInsights.Properties.Settings.Default.GithubReleaseURL);
        ...
        private void LaunchWebsite_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start(new ProcessStartInfo(LagerInsights.Properties.Settings.Default.BWBURL) { UseShellExecute = true });
            }
            catch (Exception ex)
            {
                LOGGING.Write(ex.Message, System.Reflection.MethodBase.GetCurrentMethod().Name, System.Diagnostics.EventLogEntryType.Error);
        ...
        private void Github_Click(object sender, EventArgs e)
        {
            try
            {
                Process.Start(new ProcessStartInfo(LagerInsights.Properties.Settings.Default.GithubURL) { UseShellExecute = true });
            }
            catch (Exception ex)
            {
                LOGGING.Write(ex.Message, System.Reflection.MethodBase.GetCurrentMethod().Name, System.Diagnostics.EventLogEntryType.Error);
